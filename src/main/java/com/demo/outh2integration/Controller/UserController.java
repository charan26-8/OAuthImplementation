package com.demo.outh2integration.Controller;


import com.demo.outh2integration.Repository.UserRepository;
...
public class UserController {
    ...
    void update(@PathVariable Long id, @Valid @RequestBody User res) {
        User u = repository.findById(id).orElseThrow(() -> new EntityNotFoundException());
